...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '爱玩win11的me', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yrq1622.dpdns.org', // 网站地址
  ...
  GREETING_WORDS:
    ...
    '欢迎来到我的博客🎉,Hi，我是一个小学生,Hi，我是一个干饭人,欢迎来到我的博客🎉',
